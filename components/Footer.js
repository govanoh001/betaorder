...
export default function Footer (){
    ...
    return (
       ...
       <div>
            <p className="text-2xl text-blue-500">BetaOrder</p>
        ...
        <div className="">
            <ul className="flex lg:justify-end items center gap-4">
                <li><Link href="#"><BsLinkedin className="text-blue-500 "/></Link></li>
                <li><Link href="#"><FaTwitter className="text-blue-500 "/></Link></li>
               <li><Link href="#"><FaFacebookF className="text-blue-500 "/></Link></li>
            </ul>
            <ul className="flex lg:justify-end items-center gap-4">
                <li> <Link href="#" className="text-sm text-gray-600">Glossary</Link></li>
                <li> <Link href="#" className="text-sm text-gray-600"></Link>FAQ</li>
